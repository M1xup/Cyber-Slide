...
public class DualH : MonoBehaviour
{
    [Header("References")]
    ...
    public Vector3 GetGrapplePoint(int grappleIndex)
    {
        return swingPoints[grappleIndex];
    }
    ...
    private void DrawRope()
    {
        for (int i = 0; i < amountOfSwingPoints; i++)
        {
            ...
            {
                currentGrapplePositions[i] = Vector3.Lerp(currentGrapplePositions[i], swingPoints[i], Time.deltaTime * 12f);
